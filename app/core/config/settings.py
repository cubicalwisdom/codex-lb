...
class Settings(BaseSettings):
    ...
    history_retention_days: int = Field(default=1, ge=1)
    history_retention_interval_seconds: int = Field(default=60, ge=60)
    ...
    usage_refresh_allow_plan_reconcile: bool = False
