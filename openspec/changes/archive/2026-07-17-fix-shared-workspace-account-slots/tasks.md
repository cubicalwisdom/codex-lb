...
- [x] 3.1 Run focused account repository/API tests. (Included in the 150-test focused backend pass on 2026-07-17.)
- [x] 3.2 Run OpenSpec validation. (Verified 2026-07-17 in strict mode.)
