...
- [x] 4.5 Confirm GitHub CI and Codex review on the PR head. (PR [#951](https://github.com/Soju06/codex-lb/pull/951) merged after required CI passed and Codex reported no major issues.)
