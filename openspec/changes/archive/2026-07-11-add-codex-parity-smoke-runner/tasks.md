...
- [x] 1.1 Validate this change strictly and confirm the exact 16-function / 18-case inventory still exists.
...
- [x] 2.2 Mark the agreed 16 test functions without changing their bodies, parameters, or ordinary full-suite behavior.
- [x] 2.3 Add and document `make test-codex-parity-smoke` without changing `ci-fast`, `ci`, or existing required targets.

## 3. Verification and closeout

- [x] 3.1 Confirm marker collection selects exactly 16 functions / 18 cases and no unintended tests.
