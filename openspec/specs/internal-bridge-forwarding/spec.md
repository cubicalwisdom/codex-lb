# internal-bridge-forwarding Specification

## Purpose

Define the authenticated header and body-integrity contract for forwarding a Responses request to its HTTP bridge owner.
## Requirements
